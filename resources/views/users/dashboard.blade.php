    ...
    <div class="absolute inset-0 z-0">
        <div class="swiper mySwiper h-full">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="{{ asset('storage/profile_pictures/perpus3.png') }}" class="w-full h-full object-cover" alt="Profile Image"></div>
                <div class="swiper-slide"><img src="{{ asset('storage/profile_pictures/perpus2.jpeg') }}" class="w-full h-full object-cover" alt="Profile Image"></div>
                <div class="swiper-slide"><img src="{{ asset('storage/profile_pictures/perpus1.jpeg') }}" class="w-full h-full object-cover" alt="Profile Image"></div>
            </div>
        </div>
    </div>
...
<section class="py-16 px-8 bg-blue-600 text-white text-center" data-aos="fade-up">
    ...
    <a href="{{ route('register') }}" class="px-6 py-3 bg-white text-blue-600 font-bold rounded-lg shadow-md hover:bg-gray-200 transition">Daftar Sekarang</a>
</section>
