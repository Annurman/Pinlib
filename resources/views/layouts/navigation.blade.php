...
<div class="shrink-0 flex items-center">
    <a href="{{ route('admin.dashboard') }}">
        <img src="{{ asset('storage/profile_pictures/logo-pinlib.png') }}" alt="logo" class="h-10 w-autop">
    </a>
</div>
...
<div class="d-flex justify-content-end mt-3">
    ...
    <a href="{{ url('borrowings') }}" class="menu-item">Data Peminjaman</a>
    <a href="{{ route('members.index') }}" class="menu-item">Data Member</a>
    <a href="{{ route('books.index') }}" class="menu-item">Data Buku</a>
</div>
