...
<div class="text-center">
    <?php if(optional($profile)->profile_image): ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <input type="text" name="no_hp" value="<?php echo e(old('no_hp', $profile->no_hp ?? '')); ?>" 
                    pattern="[0-9]+" 
                    inputmode="numeric" 
                    class="w-full p-2 border rounded mb-3" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <input type="date" name="tgl_lahir" value="<?php echo e(old('tgl_lahir', $profile->tgl_lahir ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <textarea name="alamat" class="w-full p-2 border rounded"><?php echo e(old('alamat', $profile->alamat ?? '')); ?></textarea>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\perpus\perpustakaan-online_1\resources\views/users/profile.blade.php ENDPATH**/ ?>