    ...
    <div x-show="openModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center transition-opacity"
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-96 relative"
            ...
            <form action="<?php echo e(route('profile.update')); ?>" method="POST">
                ...
                <input type="text" name="name" value="<?php echo e($user->name); ?>" class="w-full p-2 border rounded">

                <label class="block mt-3 mb-2 text-sm">No HP:</label>
                <input type="text" name="no_hp" value="<?php echo e($profile->no_hp ?? ''); ?>" class="w-full p-2 border rounded">

                <label class="block mt-3 mb-2 text-sm">Tanggal Lahir:</label>
                <input type="date" name="tgl_lahir" value="<?php echo e($profile->tgl_lahir ?? ''); ?>" class="w-full p-2 border rounded">
...
<?php /**PATH C:\xampp\htdocs\perpus\perpustakaan-online\resources\views/users/partials/edit-modal.blade.php ENDPATH**/ ?>