...
<div class="max-w-3xl mx-auto bg-white p-6 rounded-xl shadow">
    ...
    <form action="<?php echo e(route('books.store')); ?>" method="POST" enctype="multipart/form-data" id="book-form">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-4">
            ...
            <textarea name="description" id="description" class="form-textarea w-full" rows="3"></textarea>
        </div>

        <!-- Cover Buku -->
        <div class="mb-4">
            <label for="cover" class="block font-semibold">Upload Cover (opsional)</label>
            <input type="file" name="cover" id="cover" class="form-input w-full">
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\perpus\perpustakaan-online\resources\views/books/create.blade.php ENDPATH**/ ?>